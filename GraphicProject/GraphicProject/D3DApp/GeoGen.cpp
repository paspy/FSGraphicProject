...
void GeoGen::CreateBox(float width, float height, float depth, MeshData& meshData) {
	//
	// Create the vertices.
	//
...
void GeoGen::CreateSphere(float radius, UINT sliceCount, UINT stackCount, MeshData& meshData) {
...
void GeoGen::Subdivide(MeshData& meshData) {
...
void GeoGen::CreateGeosphere(float radius, UINT numSubdivisions, MeshData& meshData) {
	...
	for ( UINT i = 0; i < meshData.Vertices.size(); ++i ) {
		...
		float theta = D3DUtils::AngleFromXY(
...
void GeoGen::CreateCylinder(float bottomRadius, float topRadius, float height, UINT sliceCount, UINT stackCount, MeshData& meshData) {
	meshData.Vertices.clear();
	meshData.Indices.clear();
...
void GeoGen::BuildCylinderTopCap(float bottomRadius, float topRadius, float height,
...
void GeoGen::BuildCylinderBottomCap(float bottomRadius, float topRadius, float height,
	UINT sliceCount, UINT stackCount, MeshData& meshData) {
	// 
	// Build bottom cap.
	//
...
void GeoGen::CreateFullscreenQuad(MeshData& meshData) {
...
void GeoGen::CreateWaveBuffer(ID3D11Device * _d3dDevice, ID3D11Buffer ** _vertBuffer, ID3D11Buffer ** _indexBuffer, Waves _waves) {
